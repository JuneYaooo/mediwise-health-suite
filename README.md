...
[一张图看懂](#一张图看懂-mediwise) · [常用场景](#三个常用场景) · [5 分钟上手](#5-分钟上手) · [功能全览](#功能全览) · [隐私与安全](#隐私与安全) · [文档中心](docs/README.md)
...
运行要求：Python 3.8+、Node.js 18+、SQLite 3.x，以及一个能够加载 Skills、访问本地文件并执行脚本的 Agent；支持 Linux、macOS 和 Windows。生成本地 PNG 健康记录卡片或 PDF 还需要 Chrome/Chromium，纯文字记录与查询不需要。使用 OpenClaw 时要求 2026.3.0+。
