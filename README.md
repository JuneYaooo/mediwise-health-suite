...
当你说“帮我生成最近 7 天的健康记录卡片”，MediWise 会根据本地档案生成一张可以直接在聊天中查看的图片。个人版把指标趋势、饮食摄入、运动消耗、步数、睡眠、近期就医、检验、检查和在用药放在一起；家庭版则突出需要关注的成员和全家的近期医疗时间线。

#### 个人版

<p align="center">
  <img src="docs/images/health-card-example.png" width="720" alt="MediWise 个人健康记录卡片示例，包含指标趋势、摄入与消耗、睡眠、就医、检验、检查和在用药">
</p>

个人版中的热量和营养素按“有饮食记录的日期”计算日均值，不会把未记录日当作零摄入；运动消耗只代表已记录的活动，不会在缺少完整基础代谢与日常活动数据时虚构“热量缺口”。检验结果也只统计报告中明确带有高、低或异常标记的项目。
