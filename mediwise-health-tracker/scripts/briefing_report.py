...
.summary-strip{{display:grid;grid-template-columns:repeat(3,1fr);background:var(--surface);border:1px solid var(--line);border-radius:18px;margin:18px 0;padding:18px;box-shadow:0 9px 28px rgba(21,63,104,.07)}} .summary-strip>div{{padding:2px 22px;border-right:1px solid #E2EAF2}} .summary-strip>div:last-child{{border:0}} .summary-strip b{{font-size:29px;display:block;line-height:1.1;font-variant-numeric:tabular-nums}} .summary-strip span{{font-size:13px;color:var(--muted)}} .green{{color:var(--cyan)}} .blue{{color:var(--primary)}} .coral{{color:var(--coral)}} .gold{{color:var(--gold)}}
